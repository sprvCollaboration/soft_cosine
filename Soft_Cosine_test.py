...
import Soft_Cosine_class as soft_cosine
import time
...
vector_math=soft_cosine.soft_cosine('Soft Cosine test Example')
...
similarity_dictionary,word_embedding_dictionary=vector_math.soft_cosine_prep(ordered_list_features=ordered_list_features,
                                                                             word_embeddings=word_vectors,
                                                                             similarity_threshold=.50)

soft_cosine=vector_math.soft_cosine(ordered_list_features=ordered_list_features,
...
if soft_cosine > similarity_cosine:
    print('This soft cosine method improved our similarity score, Instead of a score of',str(similarity_cosine),'we now have a score of',soft_cosine)
else:
    print('Interesting...Our method did not improve our score... Look into this')
#%%
